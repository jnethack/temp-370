...
FOOD("トリカブト",    7,  1,  1, 0, VEGGY,  40, CLR_GREEN,
                                                          SPRIG_OF_WOLFSBANE),
FOOD("にんにく",       7,  1,  1, 0, VEGGY,  40, CLR_WHITE, CLOVE_OF_GARLIC),
...
FOOD("ねばねばカビ",           75,  1,  5, 0, VEGGY, 250, HI_ORGANIC, SLIME_MOLD),

/* people food */
FOOD("ロイヤルゼリー",   0,  1,  2, 0, VEGGY, 200, CLR_YELLOW,
                                                        LUMP_OF_ROYAL_JELLY),
FOOD("クリームパイ",            25,  1, 10, 0, VEGGY, 100, CLR_WHITE, CREAM_PIE),
FOOD("キャンディ",            13,  1,  2, 0, VEGGY, 100, CLR_BRIGHT_BLUE, CANDY_BAR),
...
SCROLL("悪臭雲の巻物",             "『ちゃんぴお～ん』と書かれた巻物",  1,  15, 300,
     ...
     */
SCROLL(NoDes,      "『はにゃ～ん』と書かれた巻物",  1,   0, 100, SC01),
SCROLL(NoDes,              "『ぽちっとな』と書かれた巻物",  1,   0, 100, SC02),
SCROLL(NoDes,         "『しびびんしびびん』と書かれた巻物",  1,   0, 100, SC03),
SCROLL(NoDes,            "『うしろをみろ』と書かれた巻物",  1,   0, 100, SC04),
